...
const getCSS = (COLORS) => `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .reco-block-title {
    ...
    position: sticky; top: var(--header-h, 140px); z-index: 5;
  ...
  #reco-settings, #reco-hearts, #reco-pins, #reco-ai, #reco-popular { scroll-margin-top: var(--header-h, 140px); }
    ...
    <>
      ...
      <div className="app" style={{"--header-h": headerH + "px"}}>
        <div className="header" ref={headerRef}>
          ...
          {tab==="reco"&&heartsLoaded&&(heartMemories.length>0||recoPins.length>0||aiRecos.length>0||moodFilteredNearby.length>0)&&(
