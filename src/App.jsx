            ...
            <div className="reco-section">
              ...
              <div id="ask-outsy" className="reco-block ask-outsy-block" style={{background:`linear-gradient(135deg, ${COLORS.accent}11, ${COLORS.accent}05)`,border:`1px solid ${COLORS.accent}33`,borderRadius:14,padding:"16px 16px 14px"}}>
                ...
                <div style={{position:"relative",width:"100%",marginTop:10}}>
                  ...
                  />
                  {outsyQuery && (
                    <button type="button" onClick={()=>setOutsyQuery("")} title={t.askOutsyClear||"Clear"} aria-label={t.askOutsyClear||"Clear"} style={{position:"absolute",right:50,top:11,width:22,height:22,borderRadius:"50%",border:"none",background:"transparent",color:COLORS.muted,opacity:0.55,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:12,padding:0}}>✕</button>
                  )}
              ...
              <div className="reco-location-card">
                ...
                <div className="field" style={{marginTop:4}}>
                  ...
                  <div style={{position:"relative",width:"100%"}}>
                    ...
                    {recoMood && (
                      <button type="button" onClick={()=>setRecoMood("")} title={t.askOutsyClear||"Effacer"} aria-label={t.askOutsyClear||"Effacer"} style={{position:"absolute",right:46,top:9,width:22,height:22,borderRadius:"50%",border:"none",background:"transparent",color:COLORS.muted,opacity:0.55,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,padding:0}}>✕</button>
                    )}
